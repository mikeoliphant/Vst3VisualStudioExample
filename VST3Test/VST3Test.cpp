...
VST3Test::VST3Test(void)
{
	setControllerClass(FUID(VST3TestControllerUID));
}
...
tresult PLUGIN_API VST3Test::initialize(FUnknown* context)
{
...
tresult PLUGIN_API VST3Test::terminate()
{
	return AudioEffect::terminate();
}

tresult PLUGIN_API VST3Test::setActive(TBool state)
{
	return AudioEffect::setActive(state);
}

tresult PLUGIN_API VST3Test::setState(IBStream* state)
{
...
tresult PLUGIN_API VST3Test::getState(IBStream* state)
{
	IBStreamer streamer(state, kLittleEndian);
...
tresult PLUGIN_API VST3Test::setupProcessing(ProcessSetup& newSetup)
{
	return AudioEffect::setupProcessing(newSetup);
}

tresult PLUGIN_API VST3Test::process(ProcessData& data)
{
